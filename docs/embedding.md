...
### Step two:
If a room with that name already exists, you will be redirected to that room, else you will be promted accordingly and asked if you would like to create a new room. Every room owner can have access to the embed code for embedding Scrollback on their personal or community website.

 ![Option to get the embed Script](http://i.imgur.com/G1JNR3H.png?2)

### Step three:
Copy the entire script that appears in the modal window.

 ![Copy Code](http://i.imgur.com/C6WYjZf.png?1)
